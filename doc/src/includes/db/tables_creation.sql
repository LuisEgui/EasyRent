...
create table Vehicle (
    ...
    fuelType enum ('diesel', 'electric-hybrid', 'electric',
                    'petrol', 'plug-in-hybrid') not null,
...
create table Damage (
    ...
    area enum ('brakes', 'controls', 'engine', 'front', 'general', 'interior', 
                'left', 'right', 'rear','roof', 'trunk', 'underbody', 'wheels') not null,
